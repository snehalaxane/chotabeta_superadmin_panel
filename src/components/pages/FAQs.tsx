    ...
    <div style={{ backgroundColor: '#070b14', minHeight: '100vh', width: '100%', padding: '32px', boxSizing: 'border-box' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }}>
          <div>
            <h1 style={{ color: 'white', fontSize: '18px', fontWeight: "400", margin: '0 0 4px 0' }}>FAQs</h1>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '1000px' }}>
            <thead>
              <tr style={{ backgroundColor: '#1a2233', borderBottom: '1px solid #2d3748' }}>
                ...
                <th style={{ padding: '12px', minWidth: '250px', borderRight: '1px solid #2d3748', fontSize: '11px', color: '#94a3b8', fontWeight: "400", textTransform: 'uppercase', textAlign: 'left', letterSpacing: '0.05em' }}>
      ...
      {isModalOpen && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '20px' }}>
          <div style={{ backgroundColor: '#1d2633', borderRadius: '12px', width: '100%', maxWidth: '700px', border: '1px solid #2d3748', overflow: 'hidden' }}>
            {/* Modal Header */}
            <div style={{ padding: '20px', borderBottom: '1px solid #2d3748', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <h2 style={{ color: 'white', fontSize: '16px', fontWeight: "400", margin: 0 }}>Add Faq</h2>
              <button
            ...
            <div style={{ padding: '24px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                {/* Question */}
                <div>
                  <label style={{ color: 'white', fontSize: '13px', display: 'block', marginBottom: '8px' }}>Question <span style={{ color: '#ef4444' }}>*</span></label>
                  <textarea placeholder="Enter question" rows={3} style={{ width: '100%', backgroundColor: '#0c111d', border: '1px solid #2d3748', borderRadius: '6px', padding: '10px 16px', fontSize: '13px', color: 'white', outline: 'none', resize: 'none' }} />
                </div>

                {/* Answer */}
                <div>
                  <label style={{ color: 'white', fontSize: '13px', display: 'block', marginBottom: '8px' }}>Answer <span style={{ color: '#ef4444' }}>*</span></label>
                  <textarea placeholder="Enter answer" rows={4} style={{ width: '100%', backgroundColor: '#0c111d', border: '1px solid #2d3748', borderRadius: '6px', padding: '10px 16px', fontSize: '13px', color: 'white', outline: 'none', resize: 'none' }} />
                </div>

                {/* Status */}
                <div>
                  <label style={{ color: 'white', fontSize: '13px', display: 'block', marginBottom: '8px' }}>Status</label>
                  <div style={{ position: 'relative' }}>
            ...
            {/* Modal Footer */}
            <div style={{ padding: '20px', borderTop: '1px solid #2d3748', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <button
                onClick={() => setIsModalOpen(false)}
