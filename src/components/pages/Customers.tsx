...
const tableData = [
  {
    id: 4,
    name: 'Bharath Chintamaneni',
    email: 'bharath28985@gmail.com',
    phone: '7799479489',
    walletBalance: '₹25.00',
    ...
    <div style={{ backgroundColor: '#070b14', minHeight: '100vh', width: '100%', padding: '32px', position: 'relative', boxSizing: 'border-box' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', marginBottom: '32px' }}>
          <div>
            <h1 style={{ fontSize: '20px', fontWeight: "400", color: 'white', margin: 0 }}>Customers</h1>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
            <thead>
              <tr style={{ backgroundColor: '#1a2233', borderBottom: '1px solid #2d3748' }}>
                ...
                <th style={{ padding: '12px', borderRight: '1px solid #2d3748', fontSize: '11px', color: '#94a3b8', fontWeight: "400", textTransform: 'uppercase', textAlign: 'left', letterSpacing: '0.05em' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>WALLET BALANCE <SortIcons /></div>
                </th>
            ...
            <tbody>
              {tableData.map((row) => (
                <tr key={row.id} style={{ borderBottom: '1px solid #2d3748', transition: 'background-color 0.2s' }}>
                  ...
                  <td style={{ padding: '16px', borderRight: '1px solid #2d3748', fontSize: '14px', fontWeight: "400", color: 'white' }}>{row.name}</td>
                  <td style={{ padding: '16px', borderRight: '1px solid #2d3748', fontSize: '14px', color: 'white' }}>
                    {row.email} / {row.phone}
                  </td>
                  <td style={{ padding: '16px', borderRight: '1px solid #2d3748', textAlign: 'center', fontSize: '14px', fontWeight: "400", color: 'white' }}>{row.walletBalance}</td>
                  <td style={{ padding: '16px', textAlign: 'center', fontSize: '14px', fontWeight: "400", color: 'white' }}>{row.createdAt}</td>
                </tr>
              ))}
            </tbody>
          </table>
