        ...
        <div className="px-6 py-6 border-b border-[#1e293b]/50">
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <h1 className="text-white mb-0.5 tracking-tight" style={{ fontSize: '20px' }}>Bulk Upload Categories</h1>
              ...
              <div className="flex-1">
                <div className="flex gap-4">
                  ...
                  <ul className="text-slate-400 space-y-2 list-disc list-inside" style={{ fontSize: '14px' }}>
                    ...
                    <li>Required fields: <span className="text-slate-200 font-normal">title</span></li>
                    <li className="leading-relaxed">
                      Optional fields: <span className="text-slate-300">parent_id, parent_title, description, status, requires_approval, commission, background_type, background_color, font_color</span>
                    </li>
                  </ul>
                </div>
              </div>
