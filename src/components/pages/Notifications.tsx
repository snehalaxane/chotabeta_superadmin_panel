    ...
    <div className="p-8 font-sans selection:bg-blue-500/30 text-white min-h-screen bg-[#070b14]">
      ...
      <div className="dashboard-card p-6 shadow-2xl overflow-hidden bg-[#111827] border-[#1e293b] mt-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-white text-[18px] font-bold tracking-tight">Notifications</h1>
          ...
          <div className="flex items-center gap-2">
            <button
              onMouseEnter={() => setHoveredBtn('mark-read')}
              ...
              style={{
                ...
                backgroundColor: hoveredBtn === 'mark-read' ? '#10b981' : 'transparent',
                color: hoveredBtn === 'mark-read' ? 'white' : '#10b981'
              }}
            >
